...
void InitGLAttributes(void);
void LoadShaders(void);
GLuint CreateShaderFromFile(GLenum type, const char *filename);
GLuint CreateShaderFromText(GLenum type, const char *shaderSrc);
...
GLuint CreateShaderFromFile(GLenum type, const char *filename) {
	...
	GLuint res = CreateShaderFromText(type, src);
...
void LoadShaders(void) {
	...
	VertexShader = CreateShaderFromFile(GL_VERTEX_SHADER, "vert.glsl");
	FragmentShader = CreateShaderFromFile(GL_FRAGMENT_SHADER, "frag.glsl");
